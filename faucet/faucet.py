...
class Faucet(RyuAppBase):
    ...
    def _datapath_connect(self, ryu_event):
        ...
        if valve is None:
            return
        # zof bundles the FEATURES_REPLY message into the CHANNEL_UP event.
        self._send_flow_msgs(valve, valve.switch_features(ryu_dp.features))
        discovered_up_ports = {
