...
def dedupe_output_port_acts(output_port_acts):
    ...
    Returns:
        list of ryu.ofproto.ofproto_v1_3_parser.OFPActionOutput: output to port actions.
    """
    output_ports = set([output_port_act['port_no'] for output_port_act in output_port_acts])
...
def faucet_async(datapath=None, notify_flow_removed=False, packet_in=True):  # pylint: disable=unused-argument
