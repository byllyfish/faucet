...
class ValveIPv6RouteManager(ValveRouteManager):
    ...
    _icmpv6_handlers = {
        icmpv6.ND_NEIGHBOR_SOLICIT: (_nd_solicit_handler, 'ipv6_nd_target', 32),
        icmpv6.ND_NEIGHBOR_ADVERT: (_nd_advert_handler, 'ipv6_nd_target', 32),
        icmpv6.ND_ROUTER_SOLICIT: (_router_solicit_handler, None, 32),
        icmpv6.ICMPV6_ECHO_REQUEST: (_echo_request_handler, 'payload', 96),
    }
