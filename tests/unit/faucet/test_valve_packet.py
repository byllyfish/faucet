"""Test router_advert and LACP packet code."""
...
class ValvePacketTestCase(unittest.TestCase):
    ...
    def test_router_advert(self):
        ...
        self.assertEqual(pkt.payload.hex(), '400007080000000000000000030450c0000151800000384000000000123412340000000000000000000000000101000000000001')
